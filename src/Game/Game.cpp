...
bool Game::init() {
    ...
    if (!pTanksAnimatedSprite) {
        std::cerr << "Can't find animated sprite program: " << "tankAnimatedSprite" << std::endl;
        return false;
    }

    m_pTank = std::make_unique<Tank>(pTanksAnimatedSprite, 0.00000015f, glm::vec2(0),  glm::vec2(16.f, 16.f));
